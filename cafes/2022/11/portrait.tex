...
\begin{alertblock}{\Large{Caf\'{e} LoOPS - Coarray fortran 2018}}
\end{alertblock}
...
{\textcolor{red}{
    %% Date du cafe
    \ding{228} Lundi 7 novembre 2022 de 13h \`{a} 14h.
}}
...
\begin{block}{\# find}
    %% Lieu du cafe
    \ding{228} Salle bleue du B\^{a}timent 200 de l'IJCLab\newline(Laboratoire Ir\`{e}ne Joliot Curie)
\end{block}
...
\begin{block}{\# ls}
    ...
    %% sommaire du cafe
    \ding{228} Loin de certaines id\'{e}es re\c{c}ues, Fortran aussi \'{e}volue,
...
\begin{wrapfigure}{R}{0.4\textwidth}
    ...
    et int\`{e}gre du parall\'{e}lisme natif depuis la norme 2008.
    Ce caf\'{e} sera l'occasion d'accueillir Baptiste Mary, Ing\'{e}nieur au
    centre de calcul de l'Universit\'{e} de Cergy-Paris qui viendra nous
    pr\'{e}senter les Coarray fortran 2018 (et 202X).

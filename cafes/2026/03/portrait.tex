	...
	\begin{columns}[t] % The whole poster consists of two major columns
		...
		\begin{column}{\twocolwid} % Begin a column which is two columns wide (column 2)
			...
			\begin{block}{\# ls}
				...
				pr\'{e}senter \textbf{Notebook.link}, une plateforme qui modernise
				l'exp\'{e}rience Jupyter pour le web.\\
				Elle permet de cr\'{e}er, ex\'{e}cuter et partager
				des notebooks interactifs reproductibles directement dans le navigateur, sans avoir
				\`{a} g\'{e}rer de serveur ou d'infrastructure.
				\vspace{2in}

...
\begin{frame}[t] % The whole poster is enclosed in one beamer frame
	...
	\begin{columns}[t] % The whole poster consists of two major columns
		...
		\begin{column}{\twocolwid} % Begin a column which is two columns wide (column 2)
			...
			\begin{figure}%
				\centering
				\subfloat{{\includegraphics[width=0.6\textwidth]{notebook-link-logo-with-text.png} }}%
			\end{figure}
			...
			\begin{block}{\# date}
				...
				%% Date du cafe
				\ding{228} \textbf{Mardi 10 mars 2026} de 13h \`{a} 14h.
			...
			\begin{block}{\# find}
				%% Lieu du cafe
				\ding{228} Auditorium Ir\`{e}ne Joliot-Curie, b\^{a}timent 100 d'IJCLab
			\end{block}
			...
			\begin{block}{\# ls}
				...
				%% sommaire du cafe
				\ding{228} \textbf{Martin Renou}, ing\'{e}nieur chez \textbf{QuantStack}, viendra nous
				pr\'{e}senter \textbf{Notebook.link}.\\
				Cette plateforme qui modernise l'expérience Jupyter pour le web. Elle permet de créer,
				exécuter et partager des notebooks interactifs reproductibles directement dans le navigateur,
				sans avoir à gérer de serveur ou d'infrastructure.
				\vspace{0.8in}
				...
				\begin{wrapfigure}{R}{0.38\textwidth}
					...
					\vspace{-1.3in}
					%% https://q-r-code.fr/
					\includegraphics[width=0.38\textwidth]{qrcode.png}
				\end{wrapfigure}

				\textgreater Environnements personnalisés avec ses dépendances et reproductibles\\
				\textgreater Support pour les contenus interactifs\\
				\textgreater Partage très simple des projets via un lien web\\
				\textgreater Intégration native avec GitHub\\
				\textgreater Fonctionnement entièrement côté navigateur
				\vspace{0.2in}

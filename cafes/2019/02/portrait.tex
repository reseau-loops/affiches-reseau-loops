...
\begin{alertblock}{\large{http://reseau-loops.github.io/}}
\end{alertblock}

%----------------------------------------------------------------------------------------

\centering
\raisebox{-0.5\totalheight}[0.5\totalheight]{\raisebox{\depth}{\huge{Retour d'exp\'{e}rience}}}
\raisebox{-0.3\totalheight}[0.7\totalheight]{\raisebox{\depth}{\includegraphics[width=0.25\textwidth]{julia.png}}}
...
{\textcolor{red}{
    %% Date du cafe
    \ding{228} Mardi 5 f\'{e}vrier 2019 de 13h \`{a} 14h.
}}
...
\begin{block}{\# find}
    %% Lieu du cafe
    \ding{228} Salle Jean Lascoux (aile 0) - Ecole Polytechnique.
\end{block}

\begin{block}{\# ls}

    %% sommaire du cafe
    \ding{228} Ce caf\'{e} sera l'occasion d'accueillir Fran\c cois

%% Deplacer cet objet dans le texte pour qu'il soit bien en bas
\begin{wrapfigure}{R}{0.3\textwidth}
\centering
\includegraphics[width=0.3\textwidth]{tasse.png}
\end{wrapfigure}


F\'{e}votte et Laurent Plagne (EDF) qui nous pr\'{e}senteront
un retour d'exp\'{e}rience sur le langage de programmation Julia, comprenant
une introduction au langage via des petits extraits de code illustrant
divers aspects, et quelques morceaux choisis d'un solveur de neutronique
(avec GPGPU).
\end{block}

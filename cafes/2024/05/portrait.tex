...
\begin{alertblock}{\Large{Journ\'{e}e LoOPS} - StarPU}
\end{alertblock}

%----------------------------------------------------------------------------------------

\centering
\raisebox{-0.45\totalheight}[0.4\totalheight]{\raisebox{\depth}{\includegraphics[width=0.55\textwidth]{starPU.drawio.png}}}
...
{\textcolor{red}{
    %% Date du cafe
    \ding{228} Mardi 28 mai 2024 de 10h30 \`{a} 11h30 (Pr\'{e}sentation de StarPU),
...
\begin{block}{\# find}
    %% Lieu du cafe
    \ding{228} Salle Gilles Kahn - B\^{a}timent Alan Turing Inria Saclay
\end{block}
...
\end{wrapfigure}
    ...
    %% sommaire du cafe
    \ding{228} Cette journ\'{e}e sera l'occasion d'accueillir 

...
\begin{frame}[t] % The whole poster is enclosed in one beamer frame
	...
	\begin{columns}[t] % The whole poster consists of two major columns
		...
		\begin{column}{\twocolwid} % Begin a column which is two columns wide (column 2)
			...
			\begin{figure}%
				\centering
				\subfloat{{\includegraphics[width=0.4\textwidth]{logo_cnil.png} }}%
				\qquad
				\subfloat{{\includegraphics[width=0.3\textwidth]{logo_polytechnique.png} }}%
			\end{figure}
			...
			\begin{block}{\# date}
				...
				{\textcolor{red}{
				%% Date du cafe
				\ding{228} Mardi 4 mars 2025 de 13h \`{a} 14h.
				}}
			...
			\begin{block}{\# find}
				%% Lieu du cafe
				\ding{228} Salle Gilles Kahn du B\^{a}timent Turing du Centre Inria de Saclay
			\end{block}
			...
			\begin{block}{\# ls}
				...
				%% sommaire du cafe
				\ding{228} Olivier Blazy, Professeur à Polytechnique nous pr\'{e}sentera un

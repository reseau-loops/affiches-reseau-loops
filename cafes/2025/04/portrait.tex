...
\begin{frame}[t] % The whole poster is enclosed in one beamer frame
	...
	\begin{columns}[t] % The whole poster consists of two major columns
		...
		\begin{column}{\twocolwid} % Begin a column which is two columns wide (column 2)
			...
			\begin{figure}%
				\centering
				\subfloat{{\includegraphics[width=0.6\textwidth]{pyodide.png} }}%
			\end{figure}
			...
			\begin{block}{\# date}
				...
				%% Date du cafe
				\ding{228} \textbf{Mardi 8 avril 2025} de 13h \`{a} 14h.
			...
			\begin{block}{\# ls}
				...
				%% sommaire du cafe
				\ding{228} \textbf{Roman Yurchak}, fondateur de Symerio et contributeur au

				%% Deplacer cet objet dans le texte pour qu'il soit bien en bas
				\begin{wrapfigure}{R}{0.4\textwidth}
					\centering
					%% https://q-r-code.fr/
					\includegraphics[width=0.35\textwidth]{qrcode.png}
				\end{wrapfigure}
